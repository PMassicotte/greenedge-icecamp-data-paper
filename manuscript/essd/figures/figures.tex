...
\begin{figure}[h]
	...
	\caption{(A) Under-ice vertical profiles of downwelling planar and scalar irradiance at 442 nm, 532 nm and for PAR. (B) Calculated downwelling average cosines measured beneath snow-covered sea ice. Note the log scale for the irradiance measurements (A).}
\end{figure}
...
\begin{figure}[h]
	\centering
	\includegraphics[scale = 2]{../../../graphs/fig12_only_copepoda.pdf}
	\caption{Time series of the abundance of the copepoda (ind m\textsuperscript{-1}) measured over the first 100 m and 350 m of the water column in 2016 using the zooscan.}
\end{figure}
